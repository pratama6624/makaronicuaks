                ...
                <div class="row mb-5" style="margin-top: -70px">
                    <div class="col-md-12">
                        <div class="heading-section text-center">
                            <a style="border-radius: 10px" class="btn btn-primary btn-shadow btn-lg" href="/products?filter=recomendation" role="button">Belanja lagi</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="menus d-flex align-items-center">
                            ...
                            <div class="text-wrap">
                                <div class="row align-items-start">
                                    <div class="col-4">
                                        <h4>Makaroni keju</h4>
                                        <h6 style="color: gray">Rasa keju</h6>
                                    </div>
                                    <div class="col-4 text-center">
                                        <h4>-</h4>
                                        <h6>
                                            <?= number_format("12000", 0, ',', '.') ?>
                                        </h6>
                                    </div>
                                    <div class="col-4 text-right">
                                        <a href="#">
                ...
                <div class="col-lg-4 text-center" style="background-color: lightgrey; padding-top: 40px; padding-bottom: 30px; border-radius: 20px">
                    <div class="footer-widget px-lg-5 px-0">
                        ...
                        <ul class="list-unstyled open-hours">
                            <li class="d-flex justify-content-between"><span>Makaroni pedas (x1)</span><span>Rp 15.000</span></li>
                            <li class="d-flex justify-content-between"><span>makaroni keju (x1)</span><span>Rp 12.000</span></li>
                            <br>
                            <li class="d-flex justify-content-between"><span>Total</span><span style="color: red"><b>Rp 27.000</b></span></li>
                        </ul>
                    </div>
                </div>
            </div>
